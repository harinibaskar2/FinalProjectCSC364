...
public class MapPanel extends JPanel {
  ...
  private List<Integer> tour = new java.util.ArrayList<>();
  ...
  public void setCities(List<City> cities) {
    this.cities = (cities == null) ? new java.util.ArrayList<>() : cities;
    this.tour = new java.util.ArrayList<>();
    repaint();
  }

  public void setTour(List<Integer> tour) {
    this.tour = (tour == null) ? new java.util.ArrayList<>() : tour;
    repaint();
  }
